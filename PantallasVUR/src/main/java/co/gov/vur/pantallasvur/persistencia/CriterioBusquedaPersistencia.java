 ...
 */
@Stateless
public class CriterioBusquedaPersistencia {
    @PersistenceContext
    private EntityManager em;
    
    public List<CriteriosBusqueda> getCriteriosBusqueda(){
        return em.createNamedQuery("criterioBusqueda.getAll").getResultList();
    }
}
